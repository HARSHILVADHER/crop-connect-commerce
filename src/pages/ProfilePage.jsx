...
import { ShoppingBag, PackageCheck, UserRound, Trash2, ArrowUpRight, Calendar, MapPin, Clock } from "lucide-react";
...
const ProfilePage = () => {
  ...
  const [listings, setListings] = useLocalStorageState("cropListings", []);
